!function(a){
    ...
    for(var c in a)a.hasOwnProperty(c)&&(b[a[c]]=c);return b
    };
...
return{
    ...
    for(var d=n(b),e=c;e;e=e.parentNode)if(a.inArray(e,d)>-1)return e;return null
    },p=function(a,b){
    var c=[],d=!1,e=!1;
    return function f(g){
        if(g){
    ...
    this.showImageDialog=function(c,d){
        ...
        return a.Deferred(function(a){
            ...
            c.one("shown.bs.modal",function(){
                ...
                g.off("keyup"),"pending"===a.state()&&a.reject()
                }).modal("show")
            }).promise()
...
var v=function(){
    var c=a(window),d=a(document),f=a("html, body"),i=new o,l=new r,m=new s,n=new t,q=new u,v=function(b){
        ...
        codeview:function(a){
            ...
            o?(j.val(i.html()),j.height(i.height()),l.deactivate(g),m.hide(k),j.focus(),e.hasCodeMirror&&(c=b.fromTextArea(j[0],n.codemirror),n.codemirror.tern&&(d=new b.TernServer(n.codemirror.tern),c.ternServer=d,c.on("cursorActivity",function(a){
                d.updateArgHints(a)
                })),c.setSize(null,i.outerHeight()),c.autoFormatRange&&c.autoFormatRange({
                line:0,
                ch:0
            },{
                line:c.lineCount(),
    ...
    var c=a(b.target).closest("[data-event]");
    if(c.length){
        var d,e=c.attr("data-event"),f=c.attr("data-value"),h=v(b.target);
        if(-1!==a.inArray(e,["resize","floatMe","removeMedia"])){
            var j=h.handle().find(".note-control-selection");
            d=a(j.data("target"))
            }
            if(i[e]){
            var k=h.editable();
            k.trigger("focus"),i[e](k,f,d)
            }else x[e]&&x[e].call(this,h);
        if(-1!==a.inArray(e,["backColor","foreColor"])){
            var n=h.editor().data("options",n),o=n.airMode?m:l;
            o.updateRecentColor(g.head(c),e,f)
            }
            z(b)
        }
    },F=24,G=function(a){
...
this.bindKeyMap=function(a,b){
    ...
    var c=b.extraKeys,d="";
    for(var e in c)c.hasOwnProperty(e)&&(d+="<tr><td>"+e+"</td><td>"+c[e]+"</td></tr>");return l(a.shortcut.extraKeys,d)
    },r=function(a,b){
...
this.createLayoutByAirMode=function(b,c){
    ...
    for(var l=a.summernote.lang[c.lang],m="",n=0,o=c.toolbar.length;o>n;n++){
        ...
        for(var q=0,r=p[1].length;r>q;q++)m+=i[p[1][q]](l,c);
        m+="</div>"
        }
        m='<div class="note-toolbar btn-toolbar">'+m+"</div>";
    var s=a(m).prependTo(d),v=c.keyMap[e.isMac?"mac":"pc"];
    x(s,c),w(s,v,"bottom");
    var y=a(j(l,c)).prependTo(d);
    x(y,c),w(y,v),a(k()).prependTo(d);
    var z=a(t(l,c)).prependTo(d);
    ...
    if(b.length){
        ...
        for(var d in c)c.hasOwnProperty(d)&&(c[d]=c[d].call());return c
        }

...
function fn_Handle_Form_Startup(bln_enabled){
    if(!bln_enabled){       
        ...
        $("#frm_id_distribution_application input, #frm_id_distribution_application select , #frm_id_distribution_application textarea, , #frm_id_distribution_application checkbox").prop("disabled", true);
        
        $("#frm_id_distribution_application #company:input").prop("disabled", false);

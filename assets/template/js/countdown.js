...
var CountdownImageFolder = "assets/template/js/images/";
    ...
    c.getXYWH = function(a) {
        ...
        if (a) {
            for (var f = a.offsetWidth, c = a.offsetHeight, g = jbeeb.Browser.touch; a && !isNaN(a.offsetLeft) && !isNaN(a.offsetTop); )
                g ? (b += (a.offsetLeft || 0) - (a.scrollLeft || 0), d += (a.offsetTop || 0) - (a.scrollTop || 0)) : (b += a.offsetLeft || 0, d += a.offsetTop || 0), a = a.offsetParent;
    ...
    c.getAttributes = function(a) {
        ...
        if (a = a.attributes) {
            for (var d = a.length, c = 0; c < d; c++)
                jbeeb.Browser.ie ? a[c].specified && (b[a[c].nodeName] = a[c].nodeValue.toString()) : b[a[c].nodeName] = a[c].value ? a[c].value.toString() : a[c].nodeValue.toString();
            return b
        } else
            return{}
    };
...
(function() {
    ...
    e.start = function() {
        if (!this.state)
            this.state = 1, this.bo = [], this.bo.push(this.aR = c()), this.ag ? this.bK(this.cW) : this.bK(this.af), this.bw()
    };
    e.getFPS = function() {
    ...
    e.bw = function() {
        if (this.aF == null)
            this.ag ? (b(this.bN), this.aF = true) : (this.aF && clearTimeout(this.aF), this.aF = setTimeout(this.bN, this.L))
    };
    e.bK = function(a) {
        this.bN = a.bind(this)
    };
    e.aU = function() {
        ...
        for (this.bo.unshift(a); this.bo.length > 100; )
            this.bo.pop()
    };
    e.toString = function() {
        return "[Ticker]"
    ...
    if (!jbeeb.Browser) {
        ...
        if (c === false)
            for (var e = 0; e < b.length; e++)
                if (i.style[b[e] + "AnimationName"] !== void 0) {
                    i = b[e];
                    i.toLowerCase();
                    c = true;
                    break
...
(function() {
    jbeeb.PathInfo = function() {
        function c(a, b) {
            ...
            return{source: a || null, url: i || null, protocol: k || null, domain: o || null, port: p || null, basename: v || null, ext: z || null, filename: n || null, path: l || null, pathurl: q || null, parent: m || null, parenturl: u || null, query: t || null, fragment: r || null, username: x || null, password: s || null, host: y || null}
        }
        function b(a) {
...
(function() {
    ...
    c.init = function() {
        if (!jbeeb.amReady) {
            ...
            if (window.location.href.substr(0, 4) != "http") {
                ...
                if (!jbeeb.scriptPath)
                    jbeeb.scriptPath = jbeeb.PathInfo.scriptPath
            }
    ...
    if (!jbeeb.Base)
        jbeeb.Base = c, jbeeb.register = c.dA, jbeeb.getUID = c.dh
})();
if (!jbeeb.binit)
...
(function() {
    ...
    b.init = function(a) {
        ...
        else if (this.element = document.createElement("div"), this.element.id = b, this.element.style.position = "absolute", this.element.style.overflow = "visible", this.K)
            this.K.position = "absolute", this.K.overflow = "visible";
        if (a.standalone)
            this.amStage = 1;
        ...
        if (this.K)
            b = this.K, b.padding = "0px", b.margin = "0px", b.border = "0px", b.fontSize = "100%", b.verticalAlign = "baseline", b.outline = "0px", b.background = "transparent", b.WebkitTextSizeAdjust = "100%", b.msTextSizeAdjust = "100%", b.boxSizing = "padding-box", b.backgroundClip = "padding-box";
        a.editable || this.setSelectable(false);
        this.setCursor("inherit");
        if (a)
            this.autoCenter = a.center, typeof a.flex != "undefined" && this.setFlex(a.flex), typeof a.pin != "undefined" && this.setPin(a.pin), typeof a.overflow != "undefined" && this.setOverflow(a.pin);
    ...
    b.setSelectable = function(a) {
        ...
        b.MozUserSelect = d;
        if (this.K)
            this.K.userSelect = e, this.K.MozUserSelect = d
    };
    ...
    b.applySkin = function(a, b) {
        ...
        var e = a.fill, c, h;
        if (e)
            typeof e == "string" ? (c = e, h = 1) : (c = e.color, h = e.alpha);
        this.setFill(c, h);
        ...
        if (a) {
            ...
            if (g) {
                ...
                if (k.modern)
                    ...
                    if (j = "progid:DXImageTransform.Microsoft.gradient( gradientType=" + (j == "v" ? "0" : "1") + ", startColorstr='" + g[0] + "', endColorstr='" + g[g.length - 3] + "')", this.style.filter = j, this.style.msFilter = '"' + j + '"', this.K)
                        g = this.K, g.filter = j, g.msFilter = '"' + j + '"'
                } else {
                    b = "";
                    for (n = 0; n < v; n += 3)
            ...
            if (this.K)
                g = this.K, g.backgroundColor = e || "", g.backgroundImage = b || "none", g.backgroundSize = d || "", g.backgroundRepeat = c || "", g.backgroundPosition = h || ""
        }
    };
    ...
    b.setStroke = function(a, b, e, d) {
        ...
        h.marginTop = a;
        if (this.K)
            h = this.K, h.borderStyle = d, h.borderWidth = e, h.borderColor = b, h.marginLeft = c, h.marginTop = a;
        this.al()
    };
    ...
    b.setWidth = function(a) {
        var b = this.style;
        if (b && a > 0 && (this.width = a, b.width = a + "px", this.autoCenter && this.center(this.autoCenter), this.rounded && this.al(), this.K))
            this.K.width = a + "px"
    };
    b.setHeight = function(a) {
        var b = this.style;
        if (b && a > 0 && (this.height = a, b.height = a + "px", this.autoCenter && this.center(this.autoCenter), this.rounded && this.al(), this.K))
            this.K.height = a + "px"
    };
    b.measure = function() {
    ...
    b.setSize = function(a, b) {
        var e = this.style;
        if (e && a > 0 && b > 0 && (this.width = a, this.height = b, e.width = a + "px", e.height = b + "px", this.autoCenter && this.center(this.autoCenter), this.rounded && this.al(), this.K))
            this.K.width = a + "px", this.K.height = b + "px"
    };
    b.setXY = function(a, b) {
        ...
        e.top = b + "px";
        if (this.K)
            this.K.left = a + "px", this.K.top = b + "px"
    };
    ...
    b.setXYWH = function(a, b, e, d) {
        ...
        c.top = (b || 0) + "px";
        if (this.K)
            c = this.K, c.width = (e || 0) + "px", c.height = (d || 0) + "px", c.left = (a || 0) + "px", c.top = (b || 0) + "px"
    };
    b.setX = function(a) {
        this.x = a;
        ...
        if (a > 0 && b > 0) {
            ...
            if (this.bD) {
                if (this.bD == "r" && this.parent) {
                    if (this.aP == null)
                        this.aP = this.parent.width - this.x;
            ...
            if (this.ah) {
                if (this.ah == "b" && this.parent) {
                    if (this.aa == null)
                        this.aa = this.parent.height - this.y;
                    e = this.parent.height - this.aa;
                    this.setY(e)
                }
            } else
                this.originY ? (f = this.originY, this.setY(f + (c - f) * b)) : this.setY(c * b)
        }
    ...
    b.setFlex = function(a) {
        this.aj = this.aA = 0;
        if (a)
            a.toLowerCase(), this.aA = a.match(/w/) ? 1 : 0, this.aj = a.match(/h/) ? 1 : 0;
        this.flex = a
    };
    ...
    b.al = function() {
        ...
        if (b) {
            ...
            if (h)
                h = h.weight, jbeeb.Utils.isNumber(h) && (f = h * 2);
            c = ((c < d ? c : d) + f) * 0.5;
    ...
    b.aE = function() {
        ...
        if (!(b == [] && c == [] && d == [] && f == [])) {
            for (var b = c.concat(d, f, b), c = b.length, d = [], f = [], g = 0, j = 0; j < c; j++)
                g == 0 ? b[j] == 1 && f.push("inset") : g < 4 ? f.push(b[j] + "px") : (f.push(jbeeb.Utils.makeColor(b[j], b[j + 1])), d.push(f.join(" ")), f = [], ++j, g = -1), g++;
            d.length > 0 && (h = d.join(","))
        }
    ...
    b.setBevel = function(a) {
        if (a)
            jbeeb.Utils.isNumber(a) ? a = {x: -a, y: -a, s1: 0, s2: 0, c1: "#FFFFFF", c2: "#000000", a1: 1, a2: 1} : (a.c1 = a.c1 || "#FFFFFF", a.c2 = a.c2 || "#000000");
        this.bevel = a;
        this.aE()
    };
    b.ac = function() {
    ...
    b.addMEL = function(a, b, c, d, f) {
        this.MELbubble = d;
        if (!this.bS)
            this.bS = new jbeeb.MouseEventListener(this);
    ...
    b.setFloat = function(a) {
        ...
        if (this.K)
            this.K.position = "relative", this.K.left = null, this.K.top = null, this.K.cssFloat = a, this.K.display = "inline-block"
    };
    b.destroy = function() {
        this.removeAllEventListeners();
        if (this.bS)
            this.bS.destroy(), this.bS = null;
...
(function() {
    ...
    b.init = function(a) {
        if (a) {
            ...
            this.text = a.text || "";
            if (this.K)
                b = this.K, b.fontSmooth = "always", b.WebkitFontSmoothing = "antialiased", b.textDecoration = "none", b.zoom = 1, b.size = a.h;
    ...
    b.setPadding = function(a) {
        ...
        b.paddingBottom = h;
        if (this.K)
            a = this.K, a.paddingLeft = c, a.paddingRight = d, a.paddingTop = f, a.paddingBottom = h
    };
    b.da = function() {
        ...
        d.fontWeight = c;
        if (this.K)
            d = this.K, d.fontFamily = a, d.color = b, d.textAlign = this.align, d.fontWeight = c
    };
    b.setFont = function(a) {
        this.font = a;
        this.style.fontFamily = a;
        if (this.by)
            this.by.style.fontFamily = this.font;
        if (this.K)
            this.K.fontFamily = a;
        this.as()
    };
    ...
    b.ba = function() {
        if (this.text != "") {
            ...
            a.fontSize = c;
            if (this.K)
                this.K.lineHeight = b, this.K.fontSize = c
        }
    };
    ...
    b.aL = function() {
        ...
        if (!(a == [] && b == [] && c == [] && d == [])) {
            for (var a = b.concat(c, a, d), b = a.length, c = [], d = [], h = 0, g = 0; g < b; g++)
                h == 0 ? a[g] == 1 && d.push("inset") : h < 4 ? d.push(a[g] + "px") : (d.push(jbeeb.Utils.makeColor(a[g], a[g + 1])), c.push(d.join(" ")), d = [], ++g, h = -1), h++;
            c.length > 0 && (f = c.join(","))
        }
        a = this.style;
...
(function() {
    ...
    b.toFront = function(a) {
        if (a) {
            for (var b = this.O.length, c = 0, d = b; d--; )
                if (this.O[d] == a) {
                    c = d;
                    break
                }
    ...
    b.init = function(a) {
        this.aW(a);
        if (a)
            this.stage = this.amStage == 1 ? this : this.stage, this.O = []
    };
    b.db = b.stretch;
    b.stretch = function(a, b) {
    ...
    b.destroy = function() {
        if (this.O)
            for (var a = this.O.length; a--; )
                this.O[a] && (this.O[a].destroy(), this.removeChild(this.O[a]), this.O[a] = null);
        this.O = null;
        this.ak()
    };
    ...
    b.ab = function(a) {
        if (a) {
            ...
            if (a.stage)
                ...
                if (b)
                    (c = typeof b == "string" ? document.getElementById(b) : b) ? c.nodeType === 1 ? (this.element = document.createElement("div"), this.element.id = this.id, c.appendChild(this.element)) : d = 1 : d = 1;
                if (!b || d)
...
(function() {
    ...
    b.bd = function(a) {
        ...
        if (o > 0) {
            ...
            n < s && (l >= q && (b = p(l == q ? o : o % 1E3)), l >= t && (e = p(l == t ? m : m % 60)), l >= r && (d = p(l == r ? u : u % 60)), l >= x && (f = p(l == x ? w : w % 24)));
            o = a.getUTCFullYear();
            n = a.getUTCMonth();
            m = a.getUTCDate();
            q = k.getUTCFullYear();
        ...
        c.pad(b, this.bJ);
        if (v && !this.bc && this.aB)
            this.bc = this.aD = true, this.aB(this.av);
        return b
    };
    ...
    c.pad = function(a, b) {
        if (b)
            for (var c in a) {
                for (var d = String(a[c]); d.length < b; )
                    d = "0" + d;
                a[c] = d
            }
    };
    Object.defineProperty(b, "rangeHi", {get: function() {
            return this.aJ
        }, set: function(a) {
...
(function() {
    var c = function(a) {
        ...
        this.aY = new jbeeb.Stage({target: a.target, inline: a.inline || false, w: a.w || a.width || CountdownWidth, h: a.h || a.height || CountdownHeight, rounded: f || null, fill: b || null, stroke: c || null, shadow: d || null});
        jbeeb.register(this)
    }, b = c.prototype;
    b.aM = null;
    b.aY = null;
    ...
    b.init = function() {
        ...
        this.bU = {second: {use: false, prev: [null, null], ani: [null, null], aniCount: [null, null]}, minute: {use: false, prev: [null, null], ani: [null, null], aniCount: [null, null]}, hour: {use: false, prev: [null, null], ani: [null, null], aniCount: [null, null]}, day: {use: false, prev: [null, null], ani: [null, null], aniCount: [null, null]}, month: {use: false, prev: [null, null], ani: [null, null], aniCount: [null, null]}, year: {use: false, prev: [null, null], ani: [null, null], aniCount: [null, null]}};
        ...
        for (j = 0; j < c.length; j++)
            if (j >= d && j <= f)
                k = c[j], this.bU[k].use = true, this.dJ = k;
        ...
        var r = {font: "Arial, _sans", color: "#FFFFFF", weight: "normal", bkgd: this.T == "flip" ? null : {color: ["#000000", 1, 0, "#686868", 1, 50, "#000000", 1, 50, "#535050", 1, 100], alpha: "v"}, rounded: this.T == "flip" ? null : 0.18, shadow: null}, x = {font: "Arial, _sans", color: "#303030", weight: "bold"};
        if (a.numbers)
            for (var s in r)
                a.numbers[s] && (r[s] = a.numbers[s]);
        if (a.labels)
            for (s in x)
                a.labels[s] && (x[s] = a.labels[s]);
        c.reverse();
        this.aV = {};
        this.bV = [];
        for (j = s = 0; j < c.length; j++) {
            var y = c[j];
            if (this.bU[y].use) {
                this.aV[y] = new jbeeb.Container({x: s + p / 2, y: 0, w: v, h: z, rounded: r.rounded || null, fill: jbeeb.Utils.clone(r.bkgd) || null, shadow: r.shadow || null});
                var m = this.aV[y];
                m.store = {name: y};
                this.bj[y] = v;
                if (this.T == "flip") {
                    ...
                    for (var B = [], A = 0; A < this.totalFlipDigits; A++) {
                        for (var C = new jbeeb.Container({x: u * A + t * A, y: 0, w: u, h: w}), G = [], D = 0; D < 10; D++) {
                            for (var E = new jbeeb.Container({x: 0, y: 0, w: u, h: w}), H = [], F = 0; F < 3; F++) {
                                var I = new jbeeb.Box({x: 0, y: 0, w: u, h: w, image: {url: b + ("" + D + "" + F) + "." + this.imageExt, mode: "fit"}});
                                H[F] = I;
                                E.addChild(I)
                            }
                            E.img = H;
                    ...
                    m.time.slot = B;
                    m.addChild(m.time)
                } else if (m.time = new jbeeb.TextBox({x: 0, y: 0, w: v, h: z, text: "00", textScale: k, font: r.font, textColor: r.color, align: "center"}), m.addChild(m.time), !this.ay)
                    m.line = new jbeeb.Box({x: 0, y: 0, w: v, h: o * 0.03, fill: "#000000"}), m.addChild(m.line), m.line.center();
                this.aY.addChild(m);
                if (!this.bv)
                    m.labels = new jbeeb.TextBox({x: s, y: o - f * 0.7, w: d, h: f * 0.7, font: x.font, testScale: 0.7, textColor: x.color, bold: 1, align: "center", text: this.bF[y]}), this.aY.addChild(m.labels);
                this.bV.push(m);
                m.time.center();
        ...
        this.bC = new jbeeb.TimeDiff({end: a.time ? a.time : {year: a.year || a.years, month: a.month || a.months, day: a.day || a.days, hour: a.hour || a.hours, minute: a.minute || a.minutes, second: a.second || a.seconds, ampm: a.ampm || ""}, rangeHi: g, rangeLo: h, timezoneOffset: a.offset || 0, onComplete: this.dz.bind(this), truncate: a.truncate || 0});
        this.aX = true;
    ...
    b.ar = function() {
        ...
        if (a)
            for (b = a = 0; b < this.bV.length; b++)
                c = this.bV[b], f = c.time.text, this.bb(f), c.setX(a), c.time.setWidth(c.width), c.time.center(), c.labels && (c.labels.setX(a), c.labels.setWidth(c.width)), c.line && (c.line.setWidth(c.width), c.line.center()), a += c.width + this.aI
    };
    b.bQ = function() {
        this.bn += jbeeb.ticker.getInterval();
        if (this.bn > this.L)
            this.aS = this.bC.update(), this.bn = 0;

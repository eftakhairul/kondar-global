...
$(document).ready(function () {
	...
	$shadows.mousemove(function(e){
		...
		if(dx*dx+dy*dy <= 150*150){
			...
			lastSpeed = $('#sphere').earth3d('option', 'defaultSpeed');

			$('#sphere').earth3d('option', 'defaultSpeed', 0);

		}else{

			globeHovered = false;

			$('#sphere').earth3d('option', 'defaultSpeed', lastSpeed);
  ...
  $.ajax({
    ...
    success: function(msg){
      ...
      $.each(msg, function(index, value) {
          ...
          pictures[counter] = base_url+'assets/uploads/globe_product/small/'+value['image'];
...

{
    ...
    $('body').mousemove(function(e){
        ...
        if(Math.abs(width/2 - relX) > minThreshold){
			...
			if(!globeHovered){
				...
				$('#sphere').earth3d('option', 'defaultSpeed', globeSpeed*sign);
	...
	rotateInterval = setInterval('rotateCar()', 5);

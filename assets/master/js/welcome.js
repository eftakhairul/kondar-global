...
(function($) {
    ...
    var earth_image = base_url+'assets/uploads/logo/thumbnails/earth1024x10242.jpg';
    ...
    $.widget('ui.earth3d', {
        ...
        options: {
            ...
            onInitLocation: function(location, widget) {
                ...
                var $elem = $('<div class="location"><img src="'+location.image+'" class="roticon"></div>');

                $elem.appendTo(widget.options.locationsElement);

                $elem.click(function() {

                    config.log('Clicked on ' + location.name);
            ...
            onInitFlight: function(flight, widget) {
                ...
                $elem.click(function() {
                    ...
                    config.log('Clicked on ' + flight.name);
        ...
        _create: function() {
            ...
            createSphere(this.element[0], this.options.texture, function(earth, textureWidth, textureHeight) {
                self._onSphereCreated(earth, textureWidth, textureHeight);
            }, this.options.tiling);
     ...
     */
        ...
        _orthographicProjection: function(position) {
            ...
            return {
                x: position.y + this.element.width() / 2, 
                y: position.z + this.element.height() / 2
                };
...
$(document).ready(function() {
    ...
    /*var language_selected 	= $.trim($("#language_selected").val());

			var langarr 			= '';

			var langsearch_fr 		= base_url.indexOf('fr/');

			var langsearch_ar 		= base_url.indexOf('ar/');

			if(langsearch_fr >= 0)

			{

				langarr = base_url.split('fr/');
...

			{
				...
				window.location.href = langarr+'fr/home';
...

			{
				...
				window.location.href = langarr+'ar/home';

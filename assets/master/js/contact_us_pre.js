...
$(document).ready(function() {
    ...
    $("#myForm").submit(function(e) {
        ...
        if(test == false){
            ...
            var title = $("select#salutation").val().trim();
            var country = $("select#countries").val().trim();
            var contact = $("input#contact_num").val().trim();
            var msge = $("textarea#message").val().trim();
            var branch = $("select#branch").val().trim();
            var design = $("input#designation").val().trim();
            var email = $("input#email").val().trim();
            var company = $("input#company").val().trim();
            if(name == '' || title == '' || country == '' || contact == '' || msge == '' ||  branch == '' ||  design == '' ||  email == '' || company == '' ){

                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            <div class="main-tab-award text-center">
                                                ...
                                                <div class="nav-prex-next text-center">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <a href="javascript:" id="checkSerialNumber" class="btn btn-primary btn-sm" style="width:50px">OK</a>	
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="modal-content"> 
            ...
            <div class="modal-body nopadmodal_na"> 
                <div class="box-content-modal"> 
                    ...
                    <div class="clearfix"></div>
                    <h2 class="title-modal normaltext"><?php echo ('Thank for dealing with KGT, kindly let us know you before unveiling your serial number result') ?></h2>
                    <div class="clearfix"></div>
                    <div class="row">
                    ...
                    <div class="btn-modal">
                        <div class="row">
                            <div class="col-md-12 col-xs-12 text-right">
                                <img style="display:none;" src="images/loading.gif"  alt="Loading" class="loaderimage" />&nbsp;<a href="javascript:" class="btn btn-primary btn-sm" id="saveBasicDetails"><?php echo lang('Continue') ?> <i class="glyphicon glyphicon-chevron-right"></i></a>	
                            </div>
                        </div>
            ...
            <div class="modal-body"> 
                <div class="box-content-modal"> 
                    ...
                    <div class="btn-modal">
                        <div class="row">
                            <div class="col-md-12 col-xs-12 text-right">
                                <img id="loaderimagecontinue" style="display:none;" src="images/loading.gif" alt="Loading" />	<a href="javascript:" class="btn btn-primary btn-sm" id="emailVerificationCodeSubmit"><?php echo lang('Continue') ?> <i class="glyphicon glyphicon-chevron-right"></i></a>	
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    ...
                    <h2 class="title-modal"><?php echo lang('UNFORTUNATLY THIS IS NOT A WINNING NUMBER') ?></h2>
                    <div class="clearfix"></div>
                    <div class="btn-modal">
                        <div class="row">

                            <div class="col-md-12 col-xs-12 text-right">
                                <a href="javascript:" onClick="$('#notify_award_fail').modal('hide');
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    ...
                    <h2 class="title-modal newstylewinner">Congratulation! You just won a <span id="awards_file"></span></h2>
                    <div class="clearfix"></div>
                    <div class="btn-modal">
                        <div class="row">

                            <div class="col-md-12 col-xs-12 text-right">
                                <a href="javascript:" onClick="ClaimAwardForm();" class="btn btn-primary btn-sm"><?php echo lang('Claim Award') ?> <i class="glyphicon glyphicon-chevron-right"></i></a>	
                            </div>
                        </div>
                ...
                <div class="box-content-modal">
                    ...
                    <div class="btn-modal">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12 text-right">
                                <a href="javascript:" onClick="$('#user_block_box').modal('hide');
                ...
                <div class="box-content-modal">
                    ...
                    <div class="btn-modal">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12 text-right">
                                <a href="javascript:" onClick="$('#not_kgt_part_no').modal('hide');
                                    $('#serial_number').val('');" class="btn btn-primary btn-sm"><?php echo lang('OK') ?> <i class="glyphicon glyphicon-chevron-right"></i></a>	
                            </div>
                        </div>
                ...
                <div class="box-content-modal">
                    ...
                    <div class="btn-modal">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12 text-right">
                                <a href="javascript:" onClick="$('#notify_award_w0n_thanks').modal('hide');
                                    $('#serial_number').val('');" class="btn btn-primary btn-sm"><?php echo lang('OK') ?> <i class="glyphicon glyphicon-chevron-right"></i></a>	
                            </div>
                        </div>
...
<input type="file" style="float:left" id="imgInp2" name="passport_copy"> <!-- <div class="img-preview" id="img-preview11"><img src="" class="margin-bottom-top_-10" width="70" height="70" alt=""  id="blah_imgInp2"></div>-->
                    ...
                    <div class="btn-modal">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12 text-right">
                                <a href="javascript:" class="btn btn-primary btn-sm" id="claim_award_button"><?php echo lang('Continue') ?> <i class="glyphicon glyphicon-chevron-right"></i></a>	
                            </div>
                        </div>
                    ...
                    <div class="btn-modal">
                        <div class="row margin_bottom_top_20">
                            <div class="col-md-5 col-xs-5 text-left">
                                <a href="javascript:" class="btn btn-primary btn-sm" id="backtoconfirmpage"><i class="glyphicon glyphicon-chevron-left"></i><?php echo lang('Back') ?> </a>
                            </div>
                            <div class="col-md-6 col-xs-6 text-right">
                                <img id="loaderclaimawarddatabutton" style="display:none;" src="images/loading.gif"  alt="Loading"  /> <a href="javascript:" class="btn btn-primary btn-sm" id="claim_award_data_button"><?php echo lang('Continue') ?> <i class="glyphicon glyphicon-chevron-right"></i></a>	
                            </div>
                        </div>

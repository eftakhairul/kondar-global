                ...
                foreach ($permanent_job as $set_data1):
                    ...
                    <div class="col-md-6">
                        <div class="media row">
                            ...
                            <div class="col-md-7 media-body hidden-xs" style="width:50% !important;">
                                ...
                                <div class="scope_short short"
                                     style="height:90px; overflow: hidden;"><?php echo implode(' ', array_slice(explode(' ', $set_data1['scope']), 0, 30)); ?>
                                    ...
                                </div>
...
<![endif]-->',
 ...
 <o:OfficeDocumentSettings>
  <o:AllowPNG></o:AllowPNG>
                                    ...
                                    //echo preg_replace('mso-(.*)\s', '', $set_data1['scope']);
                                    ...
                                    <div>
                                    <?php
                                    //echo preg_replace('mso-(.*)\s', '', $set_data1['qualification']);
                                    echo $set_data1['qualification'];
                                    ?>
                                        </div>
                                    <div class="clearboth"></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body hidden-xs">
                                ...
                                <p class="scope_short "
                                   style="height:90px; overflow: hidden;"><?php echo implode(' ', array_slice(explode(' ', $set_data2['scope']), 0, 30)); ?>
                                    ...</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body hidden-xs">
                                ...
                                <p class="scope_short"
                                   style="height:90px; overflow: hidden;"><?php echo implode(' ', array_slice(explode(' ', $set_data3['scope']), 0, 30)); ?>
                                    ...</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body hidden-xs">
                                ...
                                <p class="scope_short"
                                   style="height:90px; overflow: hidden;"><?php echo implode(' ', array_slice(explode(' ', $set_data4['scope']), 0, 30)); ?>
                                    ...</p>

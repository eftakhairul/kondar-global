...
<div class="modal fade modal_block">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <div class="box-content-modal">
                    <div class="blink"><h2 class="title-modal">Warning</h2></div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <!--          <p><?php //echo lang('Sorry your email ID has been blocked for 120 minutes.');         ?></p>-->
                    ...
                    $user_data = $this->session->userdata("user_interview_data");
                    ?>
                    <p id="block_message2">Unfortunately, you did not enter the correct code within the given lead-time. Therefore, you will be welcome to use an alternative email or wait for 120 minutes to use the current email <?php echo $user_data['email']; ?> within our website.</p>

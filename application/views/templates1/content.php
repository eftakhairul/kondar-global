...
<h1 class="headline" style="margin:7px 0px 0px"><?php echo $this->lang->line('prediction');?>
<a href="front/prediction/paid" class="btn btn-minier btn-info" style="margin-left:423px">Paid</a>
<a href="front/prediction/free" class="btn btn-minier btn-info">Free</a>
</h1>
				
<?php
if(isset($all_predictions)&&!empty($all_predictions)){
	$i = 0;
	foreach($all_predictions as $set_data){
		$set_data1 	= $this->comman_model->get_data_by_id('prediction',array('id'=>$set_data['prediction_id']));

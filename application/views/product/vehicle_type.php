...
<form action="products/product_brand" id="products_catagory_list_form" enctype="multipart/form-data" method="post">
    ...
    <div class="container">
        <div class="main-page">
            <div style="color: red;"><span><span style="font-weight:bold; color:black; text-decoration: underline;">Selection instruction</span></span><span style="color:black;">:</span> <?php echo $selection_instruction[0]->vehicle_type_msg;?></div>
                    ...
                    <div class="col-md-12">
                        <?php if ($this->comman_model->get_isactive_checkbox('settings', 'id', 1)) { ?>
                            <div id="check_all_btn" class="col-md-2 custom_btn">
                                ...
                                Select All (<span id="vehicle_categories_num"><?php echo count($vehicle_categories); ?></span>)
                            </div>                        
                        <?php } ?>
                    </div>
            ...
            <div class="nav-prex-next text-right">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url('products'); ?>" class="btn btn-primary btn-sm"><?php echo lang('Back') ?></a>

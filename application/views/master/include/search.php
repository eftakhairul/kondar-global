                    ...
                    <div class="btn-modal">
                        <div class="row">
                            <div class="col-md-12 col-xs-12 text-right">
                                <img id="loaderimage" style="display:none;" src="images/loading.gif" alt="Loading" />&nbsp;<a href="javascript:void(0)" class="btn btn-primary btn-sm" id="enquirysubmit_contctredirect">OK <i class="glyphicon glyphicon-chevron-right"></i></a>&nbsp;&nbsp;
                                <a style="float:right" href="javascript:void(0)" onClick="$('#enquiry_partnumber_details').modal('hide')" class="btn btn-primary btn-sm"><?php echo lang('Cancel') ?> <i class="glyphicon glyphicon-chevron-right"></i></a> 
                            </div>
                        </div>
                    </div>
                </div>

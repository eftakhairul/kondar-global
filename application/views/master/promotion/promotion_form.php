                    ...
                    <div class="col-md-5">
                        ...
                        <div class="contact-opacity">
                            <form class="form-horizontal" id="myForm" role="form" method="post">
                                ...
                                <div class="form-group">
                                    <label  class="col-sm-4 control-label" style="padding:0px 0px 0px 15px">Name and Surname</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                      <!--<input type="text" class="form-control" id="inputPassword3" name="country" placeholder="Country">-->
                                        <select name="country" id="countries" style="width:265px;display:none;">
                                            ...
                                            <option value='Canada' data-image=" <?=global_img_link('blank.gif','template/images/msdropdown/icons/')?>" data-imagecss="flag ca" data-title="Canada">Canada</option>
                                            ...
                                            <option value='India' data-image=" <?=global_img_link('blank.gif','template/images/msdropdown/icons/')?>" data-imagecss="flag in" data-title="India" selected="selected">India</option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    <h2 class="title-modal" style="float:left">Your Form</h2>
                    <div id="countdownplace" style="float:right"></div>
                    ...
                    <div class="btn-modal">				      				
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-md-4 text-center">
                                <a style="float:right" href="javascript:void(0)" id="edit_bttn" onClick="$('#modal_block').modal('hide')" class="btn btn-primary btn-sm">EDIT <i class="glyphicon glyphicon-chevron-right"></i></a>	
                            </div>
                        </div>
...
<div class="modal fade" id="modal_error">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    <h2 class="title-modal"><blink>Error</blink></h2>
                    <p id="error_msge2"></p>
                    <div class="clearfix"></div>

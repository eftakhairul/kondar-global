...
<div class="modal fade" id="modal_success">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    <h2 class="title-modal">Receipt acknowledgement</h2>
                    <p>KGT appreciate your valuable time and we thank you for contacting us. Your email is successfully received and a copy is already sent to:  <?php echo $user_email; ?>. We should review and act accordingly. If it is urgent, then please feel free to contact us by phone, as we are available 24/7. Thank you again for your valuable time.</p>
                    <div class="clearfix"></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <div class="box-content-modal">
                    ...
                    $msg = "Unfortunately, you entered wrong verification code during the 3 attempts. Therefore, you will be welcome to use an alternative email or wait for 120 minutes to use the current email ".$user_data['email']." within our website.";
                    ?>
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                   ...
                   // $msg = "Unfortunately, after we resent you 3 verification code you did not enter the right code yet.  Therefore, you will be welcome to use an alternative email or wait for 120 minutes to use the current email ".$user_data['email']." within our website.";
                    $msg = "Unfortunately, you did not enter the correct verification code even after we resend it to you for consecutive 3 times. Therefore, you are welcome to use an alternative email or wait 120 minutes to be able to use your current email address ".$user_data['email']." within our website. Thank you.";
                    ?>
...
$msg = "Unfortunately, you did not enter the correct verification code within the given lead-time. Therefore, you are welcome to use an alternative email or wait 120 minutes to be able to use your current email address " . $user_data['email'] . " within our website. Thank you.";
?>
                    <p><?php echo $msg; ?></p>
                    <div class="clearfix"></div>
                    <div class="btn-modal">

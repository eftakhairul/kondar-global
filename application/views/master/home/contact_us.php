<script type="text/javascript">
    ...
    function data_show_from_session() {
        var name = '<?php if ($block_email_info[0]->name != "")
...
?>';
        ...
        var email = '<?php if ($block_email_info[0]->email != "")
...
?>';
        ...
        var company = '<?php if ($block_email_info[0]->company != "")
...
?>';
        ...
        var branch = '<?php if ($block_email_info[0]->branch != "")
...
?>';
        ...
        var designation = '<?php if ($block_email_info[0]->designation != "")
...
?>';
        ...
        var country = '<?php if ($block_email_info[0]->country != "")
...
?>';
        ...
        var contact = '<?php if ($block_email_info[0]->contact != "")
...
?>';
        ...
        var message = '<?php if ($block_email_info[0]->message != "")

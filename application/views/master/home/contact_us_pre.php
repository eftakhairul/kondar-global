...
?>
                    <p>Unfortunately, you refreshed the page except doing verification code submission. Therefore, you will be welcome to use an alternative email or wait for 120 minutes to use the current email <?php $email; ?> within our website. </p>
                    <div class="clearfix"></div>
                    <div class="btn-modal">

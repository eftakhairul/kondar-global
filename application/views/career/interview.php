...
<div class="bodywrapper">
    ...
    <?php echo lang('Question') ?> <?php echo $question_number; ?> of <?php echo (count($all_data) + $question_number - 1) ?>:
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2"><textarea name="answer" style="height: 130px;width: 100%;color: #DE0200;" cols="157" onkeyup="countChar(this)"></textarea>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><div id="charNum"><?php echo $all_data[0]['min_words'] ?> <?php echo lang('characters remaining') ?></div>
                                                        ...
                                                        <span style="color:#F00"><b><?php echo lang('Note') ?>: </b><?php echo lang('Please dont refresh the page.') ?></span>                                                   
...
?>									  	
                            ...
                            <div class="btn-modal">
                                ...
                                <input style="float:right;display: block;margin-top: 10px;" type="submit" class="btn btn-primary btn-sm" value="<?php echo lang('Next') ?>" />
...
<!--                                <p>Unfortunately, you did not finish answer during the given lead-time. Therefore, you will be welcome to use an alternative email or wait for  120 minutes to use the current email <?php echo $user_data['email'] ?> within our website.</p>-->
                    ...
                    <div class="btn-modal">
                        ...
                        <a style="float:right" href="javascript:void(0)" onClick="$('.modal_block').modal('hide');document.location='<?php echo site_url("/career/index"); ?>'" class="block_bttn btn btn-primary btn-sm"><?php echo lang('OK') ?> <i class="glyphicon glyphicon-chevron-right"></i></a>	
            ...
            <div class="modal-body">
                ...
                <div class="box-content-modal">
                    ...
                    <div class="btn-modal">
                        ...
                        <a style="float:right" href="javascript:void(0)" id="check_bttn" onClick="$('#modal_text').modal('hide')" class="btn btn-primary btn-sm"><?php echo lang('OK') ?> <i class="glyphicon glyphicon-chevron-right"></i></a>	

	...
	<div class="bodywrapper">
        	...
        	<div class="header">
                ...
                <div>
                    <div class="row" style="min-height:130px;">
                        <div class="col-md-3">
            	           <a class="logo" href="index.php"><img src="images/logo.png" alt="logo" style="float:left;" /></a>
                        </div>
                ...
                <div class="row">
                    <div class="text-header">
                        ...
                        <div class="col-md-3 col-md-offset-1 text-right text-2">
                            <h4>
                            <a href="distribution.php">Apply for A Distribution Agrement </a> 
                        </h4>
                        </div>
                        <div class="col-md-3">
                            <div class="searchdiv">
                                      ...
                                      <ul class="nav navbar-nav parent">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="divider"></li> -->
                                                    <li><a href="car.php" class="cars">Cars</a></li>
                                                    <li><a href="car.php" class="van">Van & Pickup</a></li>
                                                    <li><a href="truck.php" class="truck">Truck & Bus</a></li>
                                                    <li><a href="truck.php" class="others">Others</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="promotion.php">Promotion Section</a>
                                            </li>
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="Login.php" >Follow Up Order</a></li>
                                                    <li><a href="Login.php" >Warranty Claim</a></li>
                                                    <li><a href="Login.php" >Instant RFQ</a></li>
                                                </ul>
                                            </li>
                                            <li class="dropdown"><a href="Login.php" class="dropdown-toggle" data-toggle="dropdown">Supplier & Investor Section <b class="caret"></b></a>
                                                <ul class="dropdown-menu">
                                                    <li><a href="Login.php" >Supplier</a></li>
                                                    <li><a href="Login.php">Investor</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                            <a href="cart_brakepad_final_empty.php"><img src="images/cart.png" alt="cart" /> Cart</a>
                                            </li>
                                      </ul>
                ...
                <div class="slider">
                    <img src="images/slider-1.jpg" alt="" class="img-responsive" style="width:100%">   
                </div>
            </div>
        </div>
        ...
        <div class="main-content" style="padding-bottom:20px; background-color: #ebebeb;">
            <div class="container" style="margin-top: -63px;">
                ...
                <a href="#"><img src="images/chat.png" alt="chat" style="margin-top: -65px; margin-left: -331px; display:none" /></a>
                <div class="clearfix"></div>
                <div class="row" style="margin-top:30px;">

                    <div class="col-md-3 container_left" style="position:relative">
                    	<div class="box-sp">
                            <img src="images/call_center_women.png" alt="girl" style="float:left; height:88px;" />
                            <div class="support_24_7">
                                ...
                                <div style="margin-top:-10px">
                                    ...
                                    <img src="images/Email_icon.png" alt="email"  style="margin-bottom: 9px; " />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="left_side">
                         ...
                         <h1 style="color: white; font-family: arial; font-size: 17px; padding-top: 4px; padding-left: 34px;">GET FREE QUOTE NOW</h1>
                            ...
                            <div style="width: 7px; padding-left: 138px; margin-top: -19px;">
                                <img src="images/horizental_seperator.png" />
                            </div>
                            ...
                            <div style="margin-top: 3px; margin-left: 66px;"><img src="images/left_seperator.png" alt="" /></div>
                            
                            
                            <div style="padding-top: 12px; padding-left: 4px; width: 25px;"><img src="images/flag_2.png" alt="" /></div>
                            ...
                            <div style="width: 7px; padding-left: 138px; margin-top: -19px;"><img src="images/horizental_seperator.png" /></div>
                            <div  style="padding-left: 152px;  margin-top: -41px;">
                                   <span  style="color: white; font-family: arial; padding-top: 21px; font-size: 11px; font-weight: bold;">+1-604-360-8805 <br> </span>
                                    <span  style="color: white; font-family: arial; font-weight: bold; padding-top: 21px; font-size: 8px; letter-spacing: 0.5px;"> DECEMBER 15, 2013</span>
                            </div>
                            <div style="margin-top: 6px; margin-left: 66px;"><img src="images/left_seperator.png" alt="" /></div>
                            
                            <div style="padding-top: 12px; padding-left: 4px; width: 25px;"><img src="images/flag_3.png" alt="" /></div>
                            ...
                            <div style="padding-top: 12px; padding-left: 4px; width: 25px;"><img src="images/flag_4.png" alt="" /></div>
                    ...
                    <div class="col-md-3">
                        ...
                        <!-- <img src="images/bussiness_women.png" alt=" " style="float: right; margin-top: -154px; margin-right: -2px;" /> -->
                              <a href="#">  <div class="box1">
                                <img src="images/warranty_icon.png" alt="" />
                                	<h6> Get Free Shipping Now </h6>
                                </div>  </a>
                                
                                
                             <a href="#" >  <div class="box2">
                                <img src="images/Laptop_icon.png" alt="" />
                                <h6> Win a Laptop </h6>
                                </div></a>
                        
                        
                            <a href="#"><div class="box3">
                                <img src="images/Free_shipping_icon.png" alt="" />
                ...
                <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="slider2">
                                <img src="images/button1.png" alt="" style=" box-shadow: -3px -4px 3px gray;  margin-left: 14px; margin-top: -8px;" />

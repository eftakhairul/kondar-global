            ...
            <div class="row bread">
                    <div class="col-md-6">
                        <div class="text-bread">
                            PRODUCT GALLERY (APPLICATION) / CARS&nbsp; <img src="assets/template/images/car_icon.png" />&nbsp;&nbsp;/&nbsp;CERAMIC BRAKE PAD &nbsp;/&nbsp; BRAND
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="text-bread">
                            NOTE: SIMULTANEOUS SELECTION IS NOT POSSIBLE SELECT ONLY ONE BRAND.
                        </div>
                    </div>
                </div>
        </div>
	        ...
	        <div class="main-page">
	        	...
	        	<div class="car-lists text-center">
	        		<div class="row">
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<img src="assets/template/images/porsche_brand.png"   id="image1" />
                            	<div class="clearfix"></div>
                            	<a href="toyota_final.php" class="btn btn-primary btn-sm">porsche</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<img src="assets/template/images/toyota_brand.png"   id="image1" />
                            	<div class="clearfix"></div>
                            	<a href="toyota_final.php" class="btn btn-primary btn-sm">toyota</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<img src="assets/template/images/ford_brand.png"   id="image1" />
                            	<div class="clearfix"></div>
                            	<a href="selected_brand_items_final.php" class="btn btn-primary btn-sm">ford</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
	        	...
	        	<div class="nav-prex-next text-right">
	        		<div class="row">
	        			<div class="col-md-12">
	        				<a href="car.php" class="btn btn-primary btn-sm">Back</a>
	        				<a href="toyota_final.php" class="btn btn-primary btn-sm">Next</a>	
	        			</div>
	        		</div>
	        	</div>

									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    ...
															    <p style="color:#000" class="visible-xs media-heading">Terms and Conditions</p>
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    ...
															    <p style="color:#000" class="visible-xs media-heading">Warranty Terms and Conditions</p>
															    <button class="btn btn-primary">Read more</button>
															</a>
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    ...
															    <p style="color:#000" class="visible-xs media-heading">BRAKE PAD CATALOG</p>
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    ...
															    <p style="color:#000" class="visible-xs media-heading">CLUTCH FACING</p>
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    ...
															    <p style="color:#000" class="visible-xs media-heading">KGT BROUCHURE</p>
															    <button class="btn btn-primary">download</button>
															</a>
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    ...
															    <p style="color:#000" class="visible-xs media-heading">CORPORATE VIDEO</p>
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    ...
															    <p style="color:#000" class="visible-xs media-heading">BRAEKE PAD POSTER</p>
															    <button class="btn btn-primary">download</button>
															</a>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-6">
                                        <div class="fb2_inside1">
                                            ...
                                            <a href="#"><span style="color: #575757; font-family: arial; font-size: 13px; line-height: 2em;">Friction Material</span></a> <br />
                                            <a href="#"><span style="color: #575757; font-family: arial; font-size: 13px; line-height: 3em;">Filtration System</a>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xs-6">
                                        <div class="fb2_inside4 col-md-6 col-xs-6">
                                            ...
                                            <a href="#"><span style="color: #575757; font-family: arial; font-size: 13px; line-height: 2em;">Careers</span></a><br />

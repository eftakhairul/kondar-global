...
$(document).ready(function() {
        						...
        						<div class="contact-opacity">
        							<form class="form-horizontal" role="form" method="post">
										...
										<div class="form-group">
										    ...
										    <div class="col-sm-8">
										      <input type="text" name="branch" value="<?php echo set_value('branch'); ?>" class="form-control" id="inputEmail3" placeholder="Branch">
                                              <span style="color:#F00;"><?php echo form_error('branch'); ?></span>
                                              
											</div>
										</div>
										  <div class="form-group">
										    <label for="inputEmail3" class="col-sm-4 control-label">Name and Surname</label>
										    <div class="col-sm-8">
										      <input type="text" name="name" value="<?php echo set_value('name'); ?>" class="form-control" id="inputEmail3" placeholder="Name and Surname">
  ...
  <option value='Zimbabwe' data-image="assets/template/images/msdropdown/icons/blank.gif" data-imagecss="flag zw" data-title="Zimbabwe">Zimbabwe</option>
										...
										<div class="form-group">
										    ...
										    <div class="col-sm-8">
										      <input type="text" name="contact" value="<?php echo set_value('contact'); ?>" class="form-control" id="inputEmail3" placeholder="Telephone">

            ...
            <div class="row bread">
                    <div class="col-md-6">
                        <div class="text-bread">
                            PRODUCT GALLERY (APPLICATION) ./TRUCK & BUS&nbsp; <img src="assets/template/images/car_icon.png" />&nbsp;&nbsp;/&nbsp;FILTERS &nbsp;/&nbsp; BRAND 
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="text-bread">
	        ...
	        <div class="main-page">
	        	...
	        	<div class="car-lists text-center">
	        		<div class="row">
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<img src="assets/template/images/chavrolet_brand.png"   id="image1" />
                            	<div class="clearfix"></div>
                            	<a href="selected_brand_items_final.php" class="btn btn-primary btn-sm">Bedford</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<img src="assets/template/images/matsubishi_brand.png"   id="image1" />
                            	<div class="clearfix"></div>
                            	<a href="selected_brand_items_final.php" class="btn btn-primary btn-sm">BWP</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<img src="assets/template/images/ford_brand2.png"   id="image1" />
                            	<div class="clearfix"></div>
                            	<a href="selected_brand_items_final.php" class="btn btn-primary btn-sm">DAF</a>
	        				</div>
	        			</div>
	        	...
	        	<div class="nav-prex-next text-right">
	        		<div class="row">
	        			<div class="col-md-12">
	        				...
	        				<a href="selected_brand_items_final.php" class="btn btn-primary btn-sm">Next</a>	
	        			</div>
	        		</div>
	        	</div>

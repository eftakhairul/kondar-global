...
<body>
	<div class="bodywrapper">
        <?php //include('include/header_cart_page.php');?>
            ...
            <div class="row bread">
                    <div class="col-md-6">
                        <div class="text-bread">
                            PRODUCT GALLERY (APPLICATION) / CARS&nbsp; <img src="assets/template/images/car_icon.png" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="text-bread">
                            NNOTE: SIMULTANEOUS SELECTION FOR BRAKE PADS AND FILTERS IS NOT POSSIBLE.
                        </div>
                    </div>
                </div>
        </div>
        ...
        <div class="container">
	        <div class="main-page">
	        	...
	        	<div class="car-lists text-center">
	        		<div class="row">
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<div class="img-pro">
                                    <!-- <img src="assets/template/images/other_pic2.png"   id="image1" /> -->
                                </div>
                            	<div class="clearfix"></div>
                            	<a href="" class="btn-sm no-active">Ceramic Brake Pads</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                                <div class="img-pro">
                                    <img src="assets/template/images/car_pic3.png"   id="image1" />
                                </div>
                            	<div class="clearfix"></div>
                            	<a href="car_brand.php" class="btn btn-primary btn-sm">Semi-Matelic Brake Pad</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<div class="img-pro"></div>
                                <!-- <img src="assets/template/images/pickup_pic2.png"   id="image1" /> -->
                            	<div class="clearfix"></div>
                            	<a href="" class="btn-sm no-active">Oil filters</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<div class="img-pro"></div>
                                <!-- <img src="assets/template/images/van_pic2.png"   id="image1" /> -->
                            	<div class="clearfix"></div>
                            	<a href="" class="btn-sm no-active">Air filter</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	<div class="img-pro"></div>
                                <!-- <img src="assets/template/images/truck_pic2.png"   id="image1" /> -->
                            	<div class="clearfix"></div>
                            	<a href="truck_brand.php" class="btn-sm no-active">Fuel filter</a>
	        				</div>
	        			</div>
	        			<!-- <div class="col-md-3">
	        				<div class="pro-item">
                                <div class="img-pro"></div>
                            	<img src="assets/template/images/bus_pic2.png"   id="image1" />
                            	<div class="clearfix"></div>
                            	<a href="" class="btn-sm no-active">Bus</a>
	        				</div>
	        			</div> -->
	        	...
	        	<div class="nav-prex-next text-right">
	        		<div class="row">
	        			<div class="col-md-12">
	        				<a href="product.php" class="btn btn-primary btn-sm">Back</a>	
	        				<a href="car_brand.php" class="btn btn-primary btn-sm">Next</a>	
	        			</div>
	        		</div>
	        	</div>

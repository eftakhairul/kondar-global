        			...
        			<div class="form-fill-cart dis-form" style="margin-top:30px">
        				<div class="row">
        					<div class="col-md-5">
        						...
        						<div class="contact-opacity">
        							<form class="form-horizontal" id="myForm" role="form" method="post" onsubmit="return show(this)">
                                	<input type="hidden" name="operation" value="set">
		                                <div class="form-group">

										    <label for="inputEmail3" class="col-sm-4 control-label">Branch</label>
										    <div class="col-sm-8">
<select name="branch" id="branch" style="width:265px;">                                              
  <option value='Vancouver' data-image="assets/template/images/msdropdown/icons/blank.gif" data-imagecss="flag ca" data-title="Andorra">Canada, Vancouver</option>
  <option value='London' data-image="assets/template/images/msdropdown/icons/blank.gif" data-imagecss="flag gb" data-title="United Arab Emirates">UK, London</option>
  <option value='Dubai' data-image="assets/template/images/msdropdown/icons/blank.gif" data-imagecss="flag ae" data-title="Afghanistan">UAE, Dubai</option>
  <option value='Tunis' data-image="assets/template/images/msdropdown/icons/blank.gif" data-imagecss="flag tn" data-title="Antigua and Barbuda">Tunisia, Tunis</option>
</select>
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-4 control-label" style="padding:0px 0px 0px 15px">Name and Surname</label>
                                            <div class="col-sm-8">
                                              <input type="text" class="form-control" name="name" id="name" placeholder="Name and Surname" value="<?php echo set_value('name'); ?>">
										...
										<div class="form-group">
										    ...
										    <div class="col-sm-8">
										      <input type="text" name="company" value="<?php echo set_value('company'); ?>" class="form-control" id="inputEmail3" placeholder="Company">
										...
										<div class="form-group">
										    ...
										    <div class="col-sm-8">
										      <input type="text" name="designation" value="<?php echo set_value('designation'); ?>" class="form-control" id="inputEmail3" placeholder="Designation">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                              ...
                                              <select name="country" id="countries" style="width:265px;">
  ...
  <option value='Zimbabwe' data-image="assets/template/images/msdropdown/icons/blank.gif" data-imagecss="flag zw" data-title="Zimbabwe">Zimbabwe</option>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                              <input type="text" class="form-control" name="contact" id="contact_num" placeholder="Telephone" value="<?php echo set_value('contact');?>">
...
?>    
        					...
        					<div class="col-md-7">
        						<div class="div-map">
        							<img src="assets/template/images/bg-map.png" alt="map" class="img-responsive" />
        						</div>

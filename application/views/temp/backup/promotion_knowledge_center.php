	        	...
	        	<div class="car-lists">
        			<div class="form-fill-cart dis-form">
	        			<div class="row">
	        				<div class="col-md-12">
	        					<div class="promotion-page">
									...
									<ul class="nav nav-tabs">
									  ...
									  <li class="active"><a href="#knowledge_center" data-toggle="tab">KNOWLEDGE CENTER</a></li>
									...
									<div class="tab-content">
									  		...
									  		<div class="download-material">
									  			<div class="row">
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    <img class="media-object" src="assets/template/images/free_shipping_img.png" alt="...">
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    <img class="media-object" src="assets/template/images/warranty_terms_condition.png" alt="...">
															    <button class="btn btn-primary">Read more</button>
															</a>
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    <img class="media-object" src="assets/template/images/brake_pad_catalog.png" alt="...">
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    <img class="media-object" src="assets/template/images/clutch.png" alt="...">
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    <img class="media-object" src="assets/template/images/KGT_Broucher.png" alt="...">
															    <button class="btn btn-primary">download</button>
															</a>
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    <img class="media-object" src="assets/template/images/corporate_video.png" alt="...">
									  				...
									  				<div class="col-md-6">
									  					<div class="media">
									  						<a class="pull-left" href="#">
															    <img class="media-object" src="assets/template/images/brake_pad_poster.png" alt="...">
															    <button class="btn btn-primary">download</button>
															</a>
										...
										<div class="tab-pane active" id="knowledge_center">
                            ...
                            in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
                             deserunt mollit anim id est laborum.</p>
                             							<img src="assets/template/images/filtration.png" style="margin:0 auto" class="img-responsive" />
                             							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad 
                            minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit 
                            in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
                             deserunt mollit anim id est laborum.</p>
										  		...
										  		<div class="row">
										  			<div class="col-md-12 col-xs-12">
										  				<div class="main-tab-award text-center">
										  					<img src="assets/template/images/enter_serial_number.png" class="img-responsive"  style="margin:0 auto; margin-top:30px;" />

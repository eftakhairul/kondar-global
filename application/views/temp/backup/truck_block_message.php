        	...
        	<div class="row bread">
	        		<div class="col-md-12">
	        			<div class="text-bread">
	        				PRODUCT GALLERY (APPLICATION) ./&nbsp;CARS &nbsp; <img src="images/car_icon.png" />&nbsp;&nbsp; /&nbsp;&nbsp;BRAND &nbsp;/&nbsp;TOYOTA &nbsp;/&nbsp;CART
	        			</div>
	        		</div>
									  ...
									  <table class="table table-bordered my-table">
									  	...
									  	<tbody>
									  		<tr style="text-align: center; background-color: rgb(219, 219, 219);">
						                        ...
						                        <td><span style="color: #575757; font-family: arial; font-size: 12px; text-align: center;">?</span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span>?</span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;">KG9641504<span></span></td>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		      		<div class="box-content-modal">
		      			<h2 class="title-modal">AFTER THREE TRIALS YOUR CODE IS STILL WRONG. PLEASE TRY AFTER 120 MINUTES.</h2>
		      			
		      			<div class="clearfix"></div>
		      			<div class="btn-modal">
		      				<div class="row">
		      					<div class="col-md-12 text-right">
		      						<a href="javascript:void(0)" onClick="$('#notify_submit').modal('hide')" class="btn btn-primary btn-sm">OK <i class="glyphicon glyphicon-chevron-right"></i></a>	
		      					</div>
		      				</div>

        	...
        	<div class="header">
                ...
                <div>
                    <div class="row" style="min-height:130px;">
                        <div class="col-md-3">
            	           <a class="logo" href="index.php"><img src="assets/template/images/logo.png" alt="logo" style="float:left;" /></a>
                        </div>
                              ...
                              <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                      <ul class="nav navbar-nav parent">
                                            ...
                                            <li>
                                            <a href="cart_brakepad_final_empty.php"><img src="assets/template/images/cart.png" alt="cart" /> Cart</a>
                                            </li>
                                      </ul>

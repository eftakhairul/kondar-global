            ...
            <div class="row bread">
                    <div class="col-md-6">
                        <div class="text-bread">
                            PRODUCT GALLERY (APPLICATION) / TRUCK & BUS&nbsp; <img src="assets/template/images/truck_icon.png" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="text-bread">
	        		...
	        		<div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="pro-item">
                                ...
                                <div class="clearfix"></div>
                                <a href="" class="btn-sm no-active">Semi-Matelic Brake Pads</a>
                            </div>
                        </div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	...
                            	<div class="clearfix"></div>
                            	<a href="truck_brand.php" class="btn btn-primary btn-sm">Air filter</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	...
                            	<div class="clearfix"></div>
                            	<a href="#" class="btn-sm no-active">Oil filter</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	...
                            	<div class="clearfix"></div>
                            	<a href="" class="btn-sm no-active">Fuel filter</a>
	        				</div>
	        			</div>
	        			<div class="col-md-3">
	        				<div class="pro-item">
                            	...
                            	<div class="clearfix"></div>
                            	<a href="" class="btn-sm no-active">Brake Linning</a>
	        				</div>
	        			</div>
	        			<!-- <div class="col-md-3">
	        				<div class="pro-item">
                                ...
                                <img src="assets/template/images/truck_pic2.png"   id="image1" />
                            	<div class="clearfix"></div>
                            	<a href="truck_brand.php" class="btn-sm no-active">Truck</a>
	        				</div>
	        			</div>-->
	        	...
	        	<div class="nav-prex-next text-right">
	        		<div class="row">
	        			<div class="col-md-12">
	        				...
	        				<a href="truck_brand.php" class="btn btn-primary btn-sm">Next</a>	
	        			</div>
	        		</div>
	        	</div>

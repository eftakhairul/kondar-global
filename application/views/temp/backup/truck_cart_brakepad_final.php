        	...
        	<div class="row bread">
	        		<div class="col-md-12">
	        			<div class="text-bread">
	        				PRODUCT GALLERY (APPLICATION) ./&nbsp;TRUCK &nbsp; <img src="images/car_icon.png" />&nbsp;&nbsp; /&nbsp;&nbsp;BRAND &nbsp;/&nbsp;TOYOTA &nbsp;/&nbsp;CART
	        			</div>
	        		</div>
									  ...
									  <table class="table table-bordered my-table">
									  	...
									  	<tbody>
									  		<tr style="text-align: center; background-color: rgb(219, 219, 219);">
						                        <td><span><input type="checkbox" name="" value=""></span></td>
                                            ...
                                            <tr style="text-align: center; background-color: rgb(219, 219, 219);">
                                                <td><span><input type="checkbox" name="" value=""></span></td>
                                                <td><span style="color: #575757; font-family: arial; font-size: 12px; text-align: center;">2</span></td>
                                                <td><span style="color: #575757; font-family: arial; font-size: 12px; text-align: center;">?</span></td>
                                                <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span>?</span></td>
                                                <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span>KG9641504</span></td>
                                                <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span><img src="images/vehicle_truck_img03.png" /></span></td>

                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                      <ul class="nav navbar-nav parent">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <!-- <li><a href="product.php" class="cars">Product</a></li>
                                                    <li class="divider"></li> -->
                                            ...
                                            <li>
                                            <a href="home/cart_filter_final"><img src="assets/template/images/cart.png" alt="cart" />  <span id="menu_cart_id">Cart [<?php echo $cartcount;?>]</span></a>
                                            </li>
                                      </ul>

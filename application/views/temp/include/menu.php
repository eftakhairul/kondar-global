...
$menu_img_link = array();
//$menu_label=array();
// given for menus and cart count, due to a menu and cart error in distribution section --- 12-04-2014 --- start
        ...
        <div class="row">
            <div class="text-header">
                ...
                <div class="col-md-3 col-md-offset-1 text-right text-2" >
                    <h4>
                        <a class="distribution_link" href="distribution" style="margin-left:-26px"><span class="blink">Apply for A Distribution Agreement </span></a> 
                    </h4>
                </div>
...
<!--                                      <a href="<?php echo base_url(); ?>home">Home</a>-->
                                        <a href="<?php echo base_url(); ?>home" class="dropdown-toggle1" data-toggle="dropdown1">Home <b class="caret"></b></a>
                                    ...
                                    <li class="dropdown">
                                        <?php if (isset($productsdropdown) && $productsdropdown == true) { ?>
                                            <a href="<?php echo base_url(); ?>products" class="dropdown-toggle1" data-toggle="dropdown1">
                                        ...
                                        <?php if (isset($menu_vehicle_categories) && !empty($menu_vehicle_categories)) { ?>
                                            <ul class="dropdown-menu">
                                                <?php foreach ($menu_vehicle_categories as $vehicle_categories1) { ?>
                                                    <li><a href="<?php echo base_url(); ?>products/product_type/<?php echo $vehicle_categories1['id']; ?>" class="cars" style="background: url('assets/uploads/vehicle_categories/<?php echo $vehicle_categories1['menu_image']; ?>') no-repeat scroll right center transparent; background-size: 30%;"><?php echo $vehicle_categories1['category_name']; ?></a></li>
                                                <?php } ?>
                                            </ul>
                                        <?php } ?>
                                        <?php if (isset($menu_product_types) && !empty($menu_product_types)) { ?>
                                            <ul class="dropdown-menu dropdown-menusmall" style="margin-left:270px;width:248px">
                                                <?php
                                                foreach ($menu_product_types as $menu_product_type) {
                                                    $link = strtolower(str_replace(' ', '_', $menu_product_type->product_type_name));
                                                    ?>
                                                    <li><a href="<?php echo base_url(); ?>products/vehicle_type/<?php echo $link; ?>" style="background: url('assets/uploads/product_type_images/<?php echo $menu_product_type->Product_Type_Photo; ?>') no-repeat scroll right center transparent;background-size: 25%;"><?php echo $menu_product_type->product_type_name; ?></a></li>
                                                <?php } ?>
                                            </ul>
                                        <?php } ?>	
                                    </li>
                                    ...
                                    <li class="dropdown">
                                        <a href="<?php echo base_url(); ?>home/Login" class="dropdown-toggle" data-toggle="dropdown">
                                            Client Section <b class="caret"></b>
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li><a style="background: url('assets/uploads/menus/<?php echo $menu_img_link['follow_up_order']; ?>') no-repeat scroll right center transparent;"  href="#" onclick="return false;" class="login_pop" ><?php echo $menu_label['follow_up_order'];?></a></li>
                                            <li><a style="background: url('assets/uploads/menus/<?php echo $menu_img_link['get_instant_quo']; ?>') no-repeat scroll right center transparent;"  href="<?= base_url() ?>products" class="" ><?php echo $menu_label['get_instant_quo'];?></a></li>
                                            <li><a style="background: url('assets/uploads/menus/<?php echo $menu_img_link['warranty_claim']; ?>') no-repeat scroll right center transparent;"  href="#" onclick="return false;" class="login_pop" ><?php echo $menu_label['warranty_claim'];?></a></li>
                                            <li><a style="background: url('assets/uploads/menus/<?php echo $menu_img_link['claim_award']; ?>') no-repeat scroll right center transparent;"  href="<?= base_url() ?>promotion/awards" class="" ><?php echo $menu_label['claim_award'];?></a></li>                                                             
                                    ...
                                    <li class="dropdown"><a href="home/Login" class="dropdown-toggle" data-toggle="dropdown">Supplier & Investor Section <b class="caret"></b></a>
                                        <ul class="dropdown-menu">
                                            <li><a style="background: url('assets/uploads/menus/<?php echo $menu_img_link['supplier']; ?>') no-repeat scroll right center transparent;"  href="#" onclick="return false;" class="login_pop" ><?php echo $menu_label['supplier'];?></a></li>
                                            <li><a style="background: url('assets/uploads/menus/<?php echo $menu_img_link['investor']; ?>') no-repeat scroll right center transparent;"  href="#" onclick="return false;" class="login_pop" ><?php echo $menu_label['investor'];?></a></li>
                                        </ul>
                                    </li>
                                   <li>

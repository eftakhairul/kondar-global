    ...
    <div class="adv_srch"  style="margin-top:10px;">
        ...
        <div class="col-md-8">
            <div class="box-list-select" style="display:inline-block; width:100%; margin-top:-3px">
                ...
                <div id="searchtypebox" class="col-md-5" style="float:left;width:400px;">
                    <div class="pull-right" id="leftblock" style="width:170px;">
                    ...
                    <div class="" id="rightblock" style="width:170px;">

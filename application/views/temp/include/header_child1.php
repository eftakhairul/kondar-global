                              ...
                              <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                      <ul class="nav navbar-nav parent">
                                            ...
                                            <li class="dropdown">
                                                <a href="front/product" class="dropdown-toggle" data-toggle="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <?php foreach($menu_vehicle_categories as $vehicle_categories1){?>
                                                    	<li><a href="front/product_type/<?php echo $vehicle_categories1['id'];?>" class="cars" style="background: url('assets/uploads/vehicle_categories/<?php echo $vehicle_categories1['menu_image'];?>') no-repeat scroll right center transparent;"><?php echo $vehicle_categories1['category_name'];?></a></li>
                                                    <?php }?>
                                            ...
                                            <li>
                                            <a href="home/cart_brakepad_final_empty"><img src="assets/template/images/cart.png" alt="cart" /> <span id="menu_cart_id">Cart [<?php echo $cartcount;?>]</span></a>
                                            </li>
                                      </ul>

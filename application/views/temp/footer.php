...
<div class="footer1" style="background-color:#F6F6F6">
    ...
    <div class="footer">
        ...
        <div class="container footer_wrap" style="padding-top: 10px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-6">
                        ...
                        <div class="fb2_inside4 col-md-6 col-xs-6">
                            ...
                            <a href="<?=base_url()?>career#part_time_job"  onClick="goUrl('<?=base_url()?>career#part_time_job')"><span style="color: #575757; font-family: arial; font-size: 13px; line-height: 2em;"><?php echo lang('Part Time Job') ?> &nbsp;(<?php echo count($part_time); ?>)</span></a><br />	

                            <a href="<?=base_url()?>career#projects_contractors"  onClick="goUrl('<?=base_url()?>career#projects_contractors')"><span style="color: #575757; font-family: arial; font-size: 13px; line-height: 2em;"><?php echo lang('Contractors') ?> &nbsp;(<?php echo count($projects_contractors); ?>)</span> </a> </div>	
            ...
            <div class="fb3 col-md-3 pull-right" style="margin-right: 0;padding: 0;"> <a href="<?=base_url()?>promotion/view_promotion/17">
                ...
                <td><!--<a href="javascript:" style="color:#F00" ><?php //echo lang('Forget Password')     ?></a>--></td>	
                    ...
                    <div class="btn-modal"> <br />
                        ...
                        <div class="row" style="margin-left:65px">
                            ...
                            <div class="col-xs-4 col-md-4 text-center"> <a href="javascript:void(0);" class="btn btn-primary btn-sm popuplogin" ><?php echo lang('Login') ?> <i class="glyphicon glyphicon-chevron-right"></i></a> </div>	

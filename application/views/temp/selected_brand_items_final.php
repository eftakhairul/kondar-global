        	...
        	<div class="row bread">
	        		<div class="col-md-12">
	        			<div class="text-bread">
	        				GALLERY (APPLICATION) /&nbsp;TRUCK &nbsp; <img src="images/truck_icon.png" />&nbsp;&nbsp; /&nbsp;&nbsp;AIR FILTER /&nbsp;&nbsp;MITSUBISHI-FORD 
	        			</div>
	        		</div>
        ...
        <div class="container">
	        <div class="main-page">
	        		...
	        		<div class="row">
	        			<div class="col-md-12">
			        		<h1 style="margin-top:0px;">
			        			<input id="Checkbox1" type="checkbox" /><span style="font-family: Arial; font-size: 22px;"> MITSUBISHI
									  ...
									  <table class="table table-bordered my-table">
									  	...
									  	<tbody>
									  		<tr style="text-align: center; background-color: rgb(219, 219, 219);">
						                        ...
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span><img src="images/vehicle_truck_img01.png" /></span></td>
						                        ...
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span><img src="images/product_truck_img01.png" /></span></td>
						                    ...
						                    <tr style="text-align: center; background-color: rgb(219, 219, 219);">
						                        ...
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span><img src="images/vehicle_truck_img02.png" /></span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span>KG9641504</span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span>MITSUBICHI CENTER NM</span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span>MEO017242</span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span><img src="images/product_truck_img02.png" /></span></td>
							...
							<h1>
			        			<input id="Checkbox1" type="checkbox" /><span style="font-family: Arial; font-size: 22px;"> FORD
									  ...
									  <table class="table table-bordered my-table">
									  	...
									  	<tbody>
									  		<tr style="text-align: center; background-color: rgb(219, 219, 219);">
						                        ...
						                        <td><span style="color: #575757; font-family: arial; font-size: 12px; text-align: center;">1</span></td>
						                        
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span><img src="images/vehicle_truck_img03.png" /></span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span>KG9641504</span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span>MITSUBICHI CENTER NM</span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span>MEO017242</span></td>
						                        <td style="color: #575757; font-family: arial; font-size: 12px; text-align: center;"><span><img src="images/product_truck_img03.png" /></span></td>
	        	...
	        	<div class="nav-prex-next text-right">
	        		<div class="row">
	        			<div class="col-md-12">
	        				<a href="truck_brand.php" class="btn btn-primary btn-sm">Back</a>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		      		<div class="box-content-modal">
		      			...
		      			<div class="clearfix"></div>
		      			<div class="btn-modal">
		      				<a style="float:left" href="product.php" class="btn btn-primary btn-sm">continue shopping <i class="glyphicon glyphicon-chevron-right"></i></a>
	        				<a style="float:right" href="truck_cart_brakepad_final.php" class="btn btn-primary btn-sm">edit cart <i class="glyphicon glyphicon-chevron-right"></i></a>	
		      			</div>
		      		</div>
		      </div>

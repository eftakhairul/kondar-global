                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12">
                                    ...
                                    <div class="block well">
                                        <div class="navbar"><div class="navbar-inner"><h5> <?php echo $this->lang->line('').'Add '.$product_name;?></h5></div></div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls"><input id="alt" name="alt" class="focustip span12" type="text" value="<?php echo set_value('alt'); ?>" ></div>
						                <span style="color:#F00;"><?php echo form_error('title'); ?></span>
                                    </div>
                                    
                                    <div class="control-group">
                                        <label class="control-label">Link:</label>
                                        <div class="controls"><input id="link" name="link" class="focustip span12" type="text" value="http://" ></div>
						                <span style="color:#F00;"><?php echo form_error('title'); ?></span>
                                    </div>

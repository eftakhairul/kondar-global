                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<select name="duration" required>
											  ...
											  ?>
											  <option <?php echo $edit_data['duration']==$dur ? "selected" : "" ?> value="<?php echo $dur ?>"><?php echo $dur ? $dur  : "select" ?></option>
											  <?php
													endforeach;
												  ?>
                                            </select>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<input type="text" name="minword" value="<?php echo $edit_data['minword']?>">
										</div>
                                    </div>                                    

                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                		<label> 
                                        	<div id="" class="selector">
                                				<a class="" style="float:right;margin-right:10px" tabindex="0" id="data-table_first" href="admin/index/add_job_section">
                                ...
                                <table aria-describedby="data-table_info" class="table table-striped dataTable" id="data-table">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th colspan="1" rowspan="1" ><?php echo $this->lang->line('').'Category';?></th>
                                            <th colspan="1" rowspan="1" width="120" ><?php echo $this->lang->line('').'Number Of Question';?></th>
...
?>
                                    ...
                                    <a href="admin/index/delete/job_section/<?php echo $set_data['id'];?>" onclick="return confirm_box();">Delete</a>
                                    </td>
                                </tr>
<?php
	}

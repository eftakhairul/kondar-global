                ...
                <div class="body">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12">
                                    ...
                                    <div class="block well">
                                        <div class="navbar"><div class="navbar-inner"><h5> <?php echo $this->lang->line('').'Add Product';?></h5></div>
                                   </div>
                                   ...
                                   <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name="product_type_id" id="product_type_id" class="focustip span12">
												...
												?>
                                                    <option value="<?php echo $product_type['id'];?>" class="<?php echo $product_type['cat_id'];?> <?php if($product_type['cat_id']==$selectedcat){echo 'selected';}?>"  <?php if($selectedsetting!=''){echo $selectedsetting;}?>  prev="<?php echo $product_type['menu_privilages_admin']; ?>"><?php echo $product_type['product_type_name'];?></option>
                                                <?php 
                                    ...
                                    <div class="productfield_display">
                                        ...
                                        <div class="controls"><input id="kgt_ref_number" name="kgt_ref_number" class="focustip span12" type="text" value="<?php echo set_value('kgt_ref_number'); ?>" ></div>
				    ...
				    <div class="control-group <?php if( strpos($defaultselectedfileds,"maker_id")<=0) { echo 'displaynon';}?>" id="maker_id">
                                  ...
                                  <div class="control-group <?php if( strpos($defaultselectedfileds,"vehicle_photo")<=0) { echo 'displaynon';}?>" id="vehicle_photo">
						                ...
						                <span style="color:#F00;"><?php echo form_error('vehicle_photo'); ?></span>
                                    </div>
                                    ...
                                    <div class="control-group <?php if( strpos($defaultselectedfileds,"knect")<=0) { echo 'displaynon';}?>" id="knect">
                                        ...
                                        <div class="controls"><input id="knect" name="knect" class="focustip span12" type="text" value="<?php echo set_value('knect'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="filtron" name="filtron" class="focustip span12" type="text" value="<?php echo set_value('filtron'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="purflux" name="purflux" class="focustip span12" type="text" value="<?php echo set_value('purflux'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="mann" name="mann" class="focustip span12" type="text" value="<?php echo set_value('mann'); ?>" ></div>
                                        ...
                                        <div class="controls">
                                            <input id="mecafilter" name="mecafilter" class="focustip span12" type="text" value="<?php echo set_value('mecafilter'); ?>" >
                                        </div>
                                        ...
                                        <div class="controls"><input id="oem_part_number" name="oem_part_number" class="focustip span12" type="text" value="<?php echo set_value('oem_part_number'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="application" name="application" class="focustip span12" type="text" value="<?php echo set_value('application'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="fleet" name="fleet" class="focustip span12" type="text" value="<?php echo set_value('fleet'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="baldwin" name="baldwin" class="focustip span12" type="text" value="<?php echo set_value('baldwin'); ?>" ></div>
                                        ...
                                        <div class="controls">
                                            <input id="others" name="others" class="focustip span12" type="text" value="<?php echo set_value('others'); ?>" >
                                        </div>
                                        ...
                                        <div class="controls"><input id="fmsi_ref_number" name="fmsi_ref_number" class="focustip span12" type="text" value="<?php echo set_value('fmsi_ref_number'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="year" name="year" class="focustip span12" type="text" value="<?php echo set_value('year'); ?>" ></div>
                                        ...
                                        <div class="controls">
                                            <input id="front_rear" name="front_rear" class="focustip span12" type="text" value="<?php echo set_value('front_rear'); ?>" >
                                        </div>
                                        ...
                                        <div class="controls"><input id="designation" name="designation" class="focustip span12" type="text" value="<?php echo set_value('designation'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="wva" name="wva" class="focustip span12" type="text" value="<?php echo set_value('wva'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="qty" name="qty" class="focustip span12" type="text" value="<?php echo set_value('qty'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="diameter" name="diameter" class="focustip span12" type="text" value="<?php echo set_value('diameter'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="width" name="width" class="focustip span12" type="text" value="<?php echo set_value('width'); ?>" ></div>
                                        ...
                                        <div class="controls"><input id="holes_no" name="holes_no" class="focustip span12" type="text" value="<?php echo set_value('holes_no'); ?>" ></div>

                        ...
                        <div class="block well" style="margin-top:30px">
                        	<div class="navbar">
                            	<div class="navbar-inner">
                                    ...
                                    <form action="<?php echo base_url();?>admin/makers/index" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                		<label> 
                                        	<div id="" class="selector">
                                				<a class="" style="float:right;margin-right:10px" tabindex="0" id="data-table_first" href="admin/makers/add_productmakers">ADD</a>
                                			</div>
                                        </label>
                               		</div>
                                </div>
                            ...
                            <div class="table-overflow">
                                ...
                                <tr class="odd">
                                 <td><input type="checkbox" id="checkitem" class="rowitemdelete" name="deleteitem[]" value="<?php echo $set_data['id'];?>"></td>	
                                    ...
                                    <td class="dataTables" valign="top"><img src="<?php echo './assets/uploads/product_maker/'.$set_data['maker_logo'];?>" style="width:100px;"/>
                                    </td>
                                	<td class="dataTables" valign="top">
                                    ...
                                    <a href="admin/makers/delete_maker/<?php echo $set_data['id'];?>" onclick="return confirm_box();">Delete</a>
                                    </td>
                                </tr>
<?php
	$i++;

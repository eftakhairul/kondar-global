                        ...
                        <div class="block well" style="margin-top:30px">
                        	<div class="navbar">
                            	<div class="navbar-inner">
                                    ...
                                    <form action="<?php echo base_url();?>admin/vehicle_categories/index" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="controls"><input type="search" id="search" name="search" class="focustip span6" value="<?php echo $search; ?>"/>
                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                		<label> 
                                        	<div id="" class="selector">
                                				<a class="" style="float:right;margin-right:10px" tabindex="0" id="data-table_first" href="admin/vehicle_categories/add_product_category">ADD</a>
                                			</div>
                                        </label>
                               		</div>
                                </div>
                            ...
                            <div class="table-overflow">
                                ...
                                <table aria-describedby="data-table_info" class="table table-striped dataTable" id="data-table">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <?php /*?><th ><?php echo $this->lang->line('').'Category Name';?></th><?php */?>
                                            <th><?php echo $this->lang->line('').'KGT Vehicle Category Generic Photo';?></th>
                                            <?php /*?><th><?php echo $this->lang->line('').'Vehicle Photo';?></th><?php */?>
                               ...
                               <?php }?>
                                ...
                                <tr class="odd">
                                    ...
                                    <td class="dataTables" valign="top">
                                    	<img src="<?php echo './assets/uploads/vehicle_categories/'.$set_data['VehicleType_Photo'];?>" style="width:100px;"/>
                                    </td>  
                                  	<td class="dataTables" valign="top">
                                    	<img src="<?php echo './assets/uploads/vehicle_categories/'.$set_data['vehicle_category_icon'];?>" style="width:100px;"/>
                                    </td>  
                                    <td class="dataTables" valign="top">
                                    	<img src="<?php echo './assets/uploads/vehicle_categories/'.$set_data['menu_image'];?>" style="width:100px;"/>
                                    </td>  
                                	<td class="dataTables" valign="top">
...
?>
                                        ...
                                        <?php if($set_data['status'] == "0"){ echo "Unpublish";}else{ echo "Publish";}?>
				                	</td>
                                	<td class="dataTables" valign="top">
                                    <a href="admin/vehicle_categories/edit_product_category/<?php echo $set_data['id'];?>">Edit</a>&nbsp;&nbsp;
                                    <a href="admin/vehicle_categories/delete/<?php echo $set_data['id'];?>" onclick="return confirm_box();">Delete</a>
                                    </td>
                                </tr>
<?php
	$i++;

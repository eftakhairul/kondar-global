                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                		<label> 
                                        	<div id="" class="selector">
                                				<a class="" style="float:right;margin-right:10px" tabindex="0" id="data-table_first" href="admin/index/add_promotion_category">
...
<?php /*?>                                            <th colspan="1" rowspan="1" width="40" ><?php echo $this->lang->line('status');?></th><?php */?>
                                            <th colspan="1" rowspan="1" width="70" ><?php echo $this->lang->line('option');?></th>
                                        </tr>
                                    </thead>
...
?>
                                    ...
                                    <a href="admin/index/delete/promotion_category/<?php echo $set_data['id'];?>" onclick="return confirm_box();">Delete</a>
                                    </td>
                                </tr>
<?php
	}

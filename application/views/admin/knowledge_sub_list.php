                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                		<label> 
                                        	<div id="" class="selector">
                                				<a class="" style="float:right;margin-right:10px" tabindex="0" id="data-table_first" href="admin/index/add_knowledge_subtitle">
                                ...
                                <table aria-describedby="data-table_info" class="table table-striped dataTable" id="data-table">
                                    <thead>
                                        <tr role="row">
                                        	...
                                        	<th colspan="1" rowspan="1" width="120"><?php echo $this->lang->line('').'Knowledge Category';?></th>
...
<?php /*?>                                    <a href="admin/view_promotion_section/<?php echo $set_data['id'];?>">View</a>&nbsp;&nbsp;<?php */?>
                                    ...
                                    <a href="admin/index/delete/knowledge_subtitle/<?php echo $set_data['id'];?>" onclick="return confirm_box();">Delete</a>

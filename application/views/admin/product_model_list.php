                        ...
                        <div class="block well" style="margin-top:30px">
                        	<div class="navbar">
                            	<div class="navbar-inner">
                                   ...
                                   <?php /*?> <div class="control-group row-fluid width50_float_left">
                                    <form action="<?php echo base_url();?>product_model/index" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                		<label> 
                                        	<div id="" class="selector">
                                				<a class="" style="float:right;margin-right:10px" tabindex="0" id="data-table_first" href="admin/product_model/add_model">ADD</a>
                                			</div>
                                        </label>
                               		</div>
                                </div>
                            ...
                            <div class="table-overflow">
                                ...
                                <td><input type="checkbox" id="checkitem" class="rowitemdelete" name="deleteitem[]" value="<?php echo $set_data['id'];?>"></td>	
                                    ...
                                    <td class="dataTables" valign="top">
                                    	<img src="<?php echo './assets/uploads/product_model/'.$set_data['model_photo'];?>" style="width:100px;"/>
                                    </td> 
                                    ...
                                    <a href="admin/product_model/delete_model/<?php echo $set_data['id'];?>" onclick="return confirm_box();">Delete</a>
                                    </td>
                                </tr>
<?php
	$i++;

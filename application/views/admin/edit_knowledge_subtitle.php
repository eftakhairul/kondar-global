                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="block well">
                                            <div class="navbar"><div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Edit Knowledge Subtitle'; ?></h5></div></div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls" style="float:left;margin-left:0px"><input type="file" name="photo" /></div>
                                                <?php
                                                if (isset($edit_data['image']) && !empty($edit_data['image'])) {
                                                    echo '<div style="float:left"><img src="assets/uploads/promotion_section/small/' . $edit_data['image'] . '"><br>';
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls" >
                                                    ...
                                                    <textarea id="content" name="sort" class="ckeditor"><?php echo $edit_data['sort']; ?></textarea>

                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                		<label> 
                                        	<div id="" class="selector">
                                				<a class="" style="float:right;margin-right:10px" tabindex="0" id="data-table_first" href="admin/index/add_library">
...
?>  
                                	...
                                	<td class="dataTables" valign="top">
										<select onchange="user_status('product_image',<?php echo $set_data['id'];?>,this.value)" style="width:100px" name="martial_id">
<?php 
...
?>
                                    ...
                                    <a href="admin/index/delete/library_product/<?php echo $set_data['id'];?>" onclick="return confirm_box();">Delete</a>
                                    </td>
                                </tr>
<?php
		}

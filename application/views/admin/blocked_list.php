                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                		<label> 
                                        	<div id="" class="selector">
                                				<a class="" href="admin/serial/delete_blocked_all" style="float:right;margin-right:10px" tabindex="0" id="data-table_first" href="admin/index/add_language">
												Delete All</a>
                                			</div>
                                        </label>
                               		</div>
                                    ...
                                    foreach($all_data as $set_data)
									{
										...
										?>
                                            <tr class="odd">
                                                ...
                                                <td class="dataTables" valign="top"> 
                                                    <a href="admin/serial/delete_blocked/<?php echo $set_data->id;?>" onclick="return confirm_box();">Delete</a>
                                                </td> 
                                            </tr>
										<?php
                                        $i++;

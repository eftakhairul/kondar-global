                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls"><input id="code" name="code" class="focustip span12" type="text" value="<?php echo $edit_data['code']; ?>" ></div>
						                <span style="color:#F00;"><?php echo form_error('code'); ?></span>
                                    </div>
                                    
                                    <div class="control-group">
                                        <label class="control-label">Part Number:</label>
                                        <div class="controls"><input id="part_number" name="part_number" class="focustip span12" type="text" value="<?php echo $edit_data['part_number']; ?>" ></div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="checkbox" name="status" value="1" <?php if($edit_data['status'] == 1){ echo '  checked="checked"';}?> <?php if(count($winners_entry)>0) {?> disabled="disabled"<?php }?> /> 
                                        </div>

...
?>                                
                                	...
                                	<tr height="">
                                    	<td width="130"><span style="font-size:large">Name:</span></td>
...
?>                                
                                	...
                                	<tr height="">
                                    	<td ><span style="font-size:large">Category:</span></td>
                                    	<td width="700"><span style="font-size:16px"><?php echo $view_data['type'];?></span></td>
                                    </tr>
                                	
                                	<tr height="">
                                    	<td ><span style="font-size:large">Description:</span></td>
                                    	<td width="700"><span style="font-size:16px"><?php echo $view_data['description'];?></span></td>
                                    </tr>

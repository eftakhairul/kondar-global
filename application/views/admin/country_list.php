                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                        <label> 
                                            <div id="" class="selector">
                                                <a class="" style="float:right;margin-right:10px" tabindex="0" id="data-table_first" href="admin/index/add_language">
                                                ...
                                                foreach ($all_data as $set_data) {
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            ...
                                                            <a href="admin/index/delete/language/<?php echo $set_data['id']; ?>" onclick="return confirm_box();">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }

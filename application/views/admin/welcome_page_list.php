...
?>
                                        ...
                                        <td><a href="admin/edit_welcome_page/globe_position/<?php echo $set_data['id'];?>">Edit</a>&nbsp;&nbsp;</td>
                                    </tr>                                    
...
?>
                                        ...
                                        <td><a href="admin/edit_welcome_page/product_position/<?php echo $set_data['id'];?>">Edit</a>&nbsp;&nbsp;</td>
                                    </tr>                                    
...
?> 
                                    ...
                                    <tr height="120">
                                    	<td width="170"><span style="font-size:large">Cart Image</span></td>
                                    	<td>
										<?php
                                        ...
                                        ?>
                                        <a href="admin/index/edit_welcome_page/cart_photo/<?php echo $set_data['id'];?>">Upload</a>&nbsp;&nbsp;
	                                    <a href="admin/index/empty_data/cart_photo/<?php echo $set_data['id'];?>" onclick="return confirm_box();">Delete</a>
										<?php	
                                        }
                                        ?> 

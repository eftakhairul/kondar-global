...
<div style="margin-right: 0px;" class="content">
    ...
    <div class="outer">
                                                ...
                                                foreach ($all_data as $set_data) {
                                                    ...
                                                    <tr class="odd">
                                                        <td class="dataTables" valign="top">
                                                            <input class="blocks" type="checkbox" name="delete_option[]" value="<?php echo $set_data['int_id']; ?>">
                                                        </td>
                                                        <td class="dataTables" valign="top">
                                                            <?php echo $int_I++; ?>
                                                        </td>
        ...
        <!--                                                <td class="dataTables" vallign="top">
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            <a href="admin/distribution/delete/<?php echo $set_data['int_id']; ?>" onclick="return confirm_box('Are you sure you want to remove This block?');"><?php echo $this->lang->line('Delete_button'); ?></a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
